...
//check of the session varialble are set or merong laman ang sessiona variable or naga exist sila
//this is to check if naka login pa yung accoun or hindi man
//if (isset($_SESSION['ses_username'])===false){
   // header("Location: index.php?logfirst");

//}elseif (isset($_REQUEST['logout'])===true) {
 //   session_destroy();
//    header("Location: index.ph?logout");
//
